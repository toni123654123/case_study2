...
//        user.setCode(textCode.getText());
        ...
        try {
            ...
            user.setMajor(major);
            if (Double.parseDouble(Scoretext.getText()) > 10) {
                JOptionPane.showMessageDialog(this, "Điểm không hợp lệ", "lỗi", JOptionPane.ERROR_MESSAGE);

            } else {
                user.setScore(Double.parseDouble(Scoretext.getText()));
            }
            ...
            JOptionPane.showMessageDialog(this, "Dữ liệu sai. Vui lòng nhập lại", "lỗi", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        contentPane.add(name, new TableLayoutConstraints(2, 2, 2, 2, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        contentPane.add(textName, new TableLayoutConstraints(3, 2, 6, 2, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- gender ----
        gender.setText("Gi\u1edbi t\u00ednh ");
        contentPane.add(gender, new TableLayoutConstraints(2, 3, 2, 3, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- radioName ----
        radioName.setText("Nam");
        contentPane.add(radioName, new TableLayoutConstraints(3, 3, 3, 3, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- radioNu ----
        radioNu.setText("N\u1eef");
        contentPane.add(radioNu, new TableLayoutConstraints(4, 3, 4, 3, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- phone ----
        phone.setText("S\u1ed1 \u0111i\u1ec7n tho\u1ea1i ");
        contentPane.add(phone, new TableLayoutConstraints(2, 4, 2, 4, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        contentPane.add(textPhone, new TableLayoutConstraints(3, 4, 6, 4, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- email ----
        email.setText("Email ");
        contentPane.add(email, new TableLayoutConstraints(2, 5, 2, 5, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        contentPane.add(textEmail, new TableLayoutConstraints(3, 5, 6, 5, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        ...
        contentPane.add(Classs, new TableLayoutConstraints(3, 6, 4, 6, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- major ----
        major.setText("Chuy\u00ean ng\u00e0nh ");
        contentPane.add(major, new TableLayoutConstraints(2, 7, 2, 7, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        ...
        contentPane.add(Major1, new TableLayoutConstraints(3, 7, 4, 7, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- address ----
        address.setText("\u0110i\u1ec3m");
        contentPane.add(address, new TableLayoutConstraints(2, 8, 2, 8, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        contentPane.add(Scoretext, new TableLayoutConstraints(3, 8, 3, 8, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- addButton1 ----
        addButton1.setText("Th\u00eam");
        addButton1.addActionListener(e -> addButton1ActionPerformed(e));
        contentPane.add(addButton1, new TableLayoutConstraints(2, 10, 2, 10, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));

        //---- backButton ----
        backButton.setText("Quay l\u1ea1i");
        backButton.addActionListener(e -> backButtonActionPerformed(e));
        contentPane.add(backButton, new TableLayoutConstraints(5, 10, 5, 10, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
        pack();
